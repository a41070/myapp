...
var callbackUrl =
"https://infinite-tor-61256.herokuapp.com/oauthRedirect";
...
// Replace the callbackURL string with your own deployed
servers path to handle the OAuth redirect
...
// To keep the example simple, the user's Onshape profile is
returned to
// represent the logged-in user. In a typical application,
you would want
// to associate the Onshape account with a user record in
your database,
...
function onOAuthTokenReceived (body, req) {var jsonResponse;
